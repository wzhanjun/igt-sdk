...
use Wzhanjun\Igetui\Sdk\Igetui\IGtMultiMedia;
use Wzhanjun\Igetui\Sdk\Igetui\MediaType;
...
//    	$template = IGtNotificationTemplateDemo();
    ...
    $template = SmsDemo();
    //个推信息体
    $message = new \Wzhanjun\Igetui\Sdk\Igetui\IGtSingleMessage();
...
//	$message->set_PushNetWorkType(0);//设置是否根据WIFI推送消息，1为wifi推送，0为不限制推送
    //接收方
    $target = new \Wzhanjun\Igetui\Sdk\Igetui\IGtTarget();
